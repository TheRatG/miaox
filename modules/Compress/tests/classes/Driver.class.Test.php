<?php
class Miao_Compress_Driver_Test extends PHPUnit_Framework_TestCase
{
	...
	{
		$log = Miao_Log::factory2( $this->_tmpDir . '/' . 'test_merge_file_log' );
				
		$obj = new Miao_Compress_Driver( $log );
