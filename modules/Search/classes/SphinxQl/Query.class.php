 ...
 */
abstract class Miaox_Search_SphinxQl_Query
{
	/**
	...
	*/
	 ...
	 *
	 * @param  Miaox_Search_SphinxQl_Query_Expression  $value  The input string, eventually wrapped in an expression to leave it untouched
	 *
	 * @return  Miaox_Search_SphinxQl_Query_Expression The untouched Expression or the quoted string
	 */
	protected function _quote( $value )
	{
		...
		elseif ( $value instanceof Miaox_Search_SphinxQl_Query_Expression )
		{
